...
namespace SchoolManagement.DataAccess.Migrations
{
    ...
    [Migration("20210208084751_addSubjectTable1")]
    partial class addSubjectTable1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Models.ViewModels.ClassModel", b =>
                {
            ...
            modelBuilder.Entity("SchoolManagement.Models.ViewModels.Payments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchoolManagement.Models.ViewModels.UserModel", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchoolManagement.Models.ViewModels.ClassModel", b =>
                {
                    b.HasOne("SchoolManagement.Models.ViewModels.TeacherModel", "TeacherModel")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Models.ViewModels.StudentModel", b =>
                {
                    b.HasOne("SchoolManagement.Models.ViewModels.ClassModel", "ClassModel")
                        .WithMany()
                        .HasForeignKey("Class")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
